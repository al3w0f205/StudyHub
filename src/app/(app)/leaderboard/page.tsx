...
export const metadata: Metadata = { title: "Clasificación Global — StudyHub" };
...
function getAvatarUrl(user: { name: string; image?: string | null }) {
  return (
    user.image ||
...
export default async function LeaderboardPage() {
  ...
  const currentUserRank =
    rankings.findIndex((r) => r.id === session?.user?.id) + 1;

  return (
    <div
      style={{ maxWidth: "800px", margin: "0 auto", padding: "2rem 1.25rem" }}
    >
      {/* Header */}
      <div
        className="page-header"
        style={{ textAlign: "center", display: "block", marginBottom: "3rem" }}
      >
        <h1
        ...
        <p className="page-subtitle" style={{ fontSize: "1.125rem" }}>
          Los estudiantes con mayor rendimiento en StudyHub
        </p>
        <Link
          href="/dashboard"
            ...
            >
              <div style={{ position: "relative", marginBottom: "0.5rem" }}>
                <Image
                  ...
                  style={{
                    borderRadius: "50%",
                    border: "4px solid var(--warning-400)",
                    padding: "3px",
              ...
              >
                <div
                  style={{
                    ...
                    textAlign: "center",
                    fontWeight: "700",
                    color: index < 3 ? "var(--accent-400)" : "var(--text-tertiary)",
                    fontSize: "0.875rem",
                  }}
                >
                  {index + 1}
                ...
                <div style={{ flex: 1 }}>
                  <div style={{ fontWeight: "600", fontSize: "0.9375rem" }}>
                    {user.name}{" "}
                    {user.id === session?.user?.id && (
                      <span style={{ fontSize: "0.7rem", color: "var(--accent-400)" }}>
                        (Tú)
                      </span>
                    )}
                  </div>
                  ...
                  >
                    ...
                    {user.streak > 0 && (
                      <span style={{ color: "var(--warning-400)", fontWeight: "600" }}>
                        🔥 {user.streak}
                      </span>
                    )}
                  </div>
