// AdminQuestionEditor — Modal de edición in-situ para administradores.
// Permite editar texto, opciones, respuesta correcta, pista y explicación
// de una pregunta directamente desde la interfaz del quiz.
// Usa framer-motion para animación de entrada/salida del modal.
// Los cambios se guardan vía PATCH /api/admin/questions.
"use client";
