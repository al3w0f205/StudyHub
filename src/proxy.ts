...
export default auth((req: NextRequest & { auth: any }) => {
  ...
  response.headers.set(
    ...
    [
      "default-src 'self'",
      "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cdn.jsdelivr.net https://*.uploadthing.com https://static.cloudflareinsights.com",
      ...
      "connect-src 'self' https://utfs.io https://api.uploadthing.com https://cloudflareinsights.com",
