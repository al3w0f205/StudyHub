 ...
 * @returns {boolean}
 */
export function isSubscriptionActive(subscriptionExpiry) {
 ...
 * @returns {number}
 */
export function daysRemaining(subscriptionExpiry) {
  if (!subscriptionExpiry) return 0;
  const diff = new Date(subscriptionExpiry) - new Date();
