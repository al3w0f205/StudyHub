// QuizResults — Pantalla de resultados al finalizar un cuestionario.
// Muestra porcentaje, score absoluto, emoji contextual (🏆/👍/📚),
// y mensaje motivacional según el rendimiento.
"use client";
