  ...
  return (
    <div style={{
      ...
      <div className="solid-card animate-fade-in" style={{
        maxWidth: 500, width: "100%", padding: "2rem",
        border: "1px solid var(--border-default)",
        boxShadow: "0 20px 40px rgba(0,0,0,0.5)"
      }}>
        <div style={{ fontSize: "3rem", textAlign: "center", marginBottom: "1rem" }}>⚠️</div>
        <h2 style={{ fontSize: "1.25rem", fontWeight: 800, marginBottom: "1rem", textAlign: "center", color: "var(--danger-400)" }}>
        ...
        <p style={{ fontSize: "0.875rem", color: "var(--text-secondary)", marginBottom: "1.5rem", lineHeight: 1.6 }}>
          Al continuar, aceptas que <strong>compartir tu cuenta, grabar, o difundir el material</strong> de estos cuestionarios resultará en la <strong>suspensión inmediata y permanente</strong> de tu cuenta sin derecho a reembolso.
        </p>
        ...
        <label style={{
          ...
          marginBottom: "1.5rem", border: "1px solid var(--border-default)"
        }}>
          <input 
            type="checkbox" 
            checked={checked} 
            onChange={(e) => setChecked(e.target.checked)}
            style={{ marginTop: "0.25rem", accentColor: "var(--danger-400)", width: 18, height: 18 }} 
          />
          <span style={{ fontSize: "0.8125rem", color: "var(--text-primary)", fontWeight: 500, lineHeight: 1.4 }}>
            He leído y acepto las consecuencias de compartir mi cuenta o difundir el material.
          </span>
        </label>
