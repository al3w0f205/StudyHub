    ...
    >
      ...
      >
        ...
        >
          ...
          <h1 style={{ fontSize: "1.25rem", fontWeight: "700", textAlign: "center" }}>
            {mode === "admin" ? "Panel Administrativo" : "Bienvenido de vuelta"}
          </h1>
          <p style={{ fontSize: "0.875rem", color: "var(--text-tertiary)", textAlign: "center", marginTop: "0.25rem" }}>
            {mode === "admin"
        ...
        {mode === "admin" ? (
          ...
          <form action={handleAdminLogin}>
            ...
            <button type="submit" className="btn btn-primary btn-lg" style={{ width: "100%" }} id="admin-login-submit">
              Ingresar al Panel
            </button>
          </form>
        ) : (
