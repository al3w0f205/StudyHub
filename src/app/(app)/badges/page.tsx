...
export const metadata: Metadata = { title: "Trofeos y Logros — StudyHub" };
...
export default async function BadgesPage() {
  ...
  return (
    <div
      style={{ maxWidth: "1000px", margin: "0 auto", padding: "2rem 1.25rem" }}
    >
      {/* Header Premium */}
      <div
        style={{
        ...
        >
          <div
            style={{
              ...
              background:
                "linear-gradient(90deg, var(--primary-500) 0%, var(--accent-500) 100%)",
      ...
      >
        <div
          ...
          style={{ padding: "1.25rem", border: "1px solid var(--border-default)" }}
        >
          <div
            style={{
              display: "flex",
...
function BadgeRow({ badge, earnedAt }: { badge: Badge; earnedAt?: Date }) {
