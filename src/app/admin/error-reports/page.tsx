...
export const metadata: Metadata = { title: "Reportes de Error — Admin" };
  ...
  if (hasError) {
    return (
      ...
      >
        ...
        <Link href="/admin/error-reports" className="btn btn-primary">
          Reintentar
        </Link>
      </div>
    );
      ...
      >
        <div>
          ...
          <p style={{ color: "var(--text-tertiary)", fontSize: "0.875rem" }}>
            Problemas reportados por los usuarios en las preguntas
          </p>
        </div>
                ...
                >
                  ...
                  <td style={{ padding: "1rem" }}>
                    ...
                    <div
                      style={{ fontSize: "0.75rem", color: "var(--text-tertiary)" }}
                    >
                      {report.question?.category?.career.name}
                    </div>
                  </td>
                  <td
                    style={{
