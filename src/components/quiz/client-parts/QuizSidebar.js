// QuizSidebar — Panel lateral del quiz.
// Contiene: selector de carrera, navegación de categorías, modos de estudio
// (cuestionario/flashcards/teoría/examen), y herramientas (presión de tiempo,
// modo enfoque, mezclar preguntas, reiniciar progreso).
"use client";
