...
export const previewCareersData = [
  {
    name: "Medicina",
    categories: [{ _count: { questions: 420 } }, { _count: { questions: 280 } }],
  },
  {
    name: "Ingeniería",
    categories: [{ _count: { questions: 260 } }, { _count: { questions: 180 } }],
  },
...
export const features: Feature[] = [
  ...
  },
  {
    ...
    description:
      "Accede instantáneamente desde tu pantalla de inicio con una experiencia optimizada para navegación móvil.",
  },
];
